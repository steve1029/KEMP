...
from KEMP_sms import *
from KEMP_sms import structures as stc
...
def drude_cs(alpha, beta):
    return 

def cp_cs(alpha, beta):
    dt = 0.5
    c1 = (2-alpha*dt)/(2+alpha*dt)
    c2 = (2-alpha*dt)/(2+alpha*dt)
    return


print Au_pole0.c1, Au_pole0.c2, Au_pole0.c3
print Au_pole1.c1, Au_pole1.c2, Au_pole1.c3
print Au_pole2.c1, Au_pole2.c2, Au_pole2.c3

#plt.ion()

t0 = dt.now()
tc = 1000
tmax = 100000 # 5 period for 1000 nm wavelength
